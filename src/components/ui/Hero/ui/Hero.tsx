...
const Hero = () => {
  return (
    <>
      <div className="relative -mx-6 md:-mx-8 xl:-mx-11">
        ...
        <picture>
          ...
          <Image
            ...
            height={1249}
            alt="hero background"
            className="w-full object-cover h-171.5 md:h-[801px] z-20"
            priority
          />
        </picture>
      </div>
      <div className="absolute top-38 sm:top-70 md:top-90 grid md:grid-cols-[1fr_24px] items-center sm:justify-items-center md:justify-center w-full z-10">
        <section id="guling-cafe" className="w-auto">
          <h1 className="font-display text-white leading-[100%] text-[70px] xs:w-100 sm:w-auto md:text-8xl xl:text-9xl">
            El Guling Cafe
          </h1>
      ...
      <div className="absolute md:grid md:grid-cols-[24px_1fr] 2xl:grid-cols-[34px_1fr] bottom-14.25 md:bottom-20 z-50">
        <hr className="hidden md:block h-full w-0 border-white border-2" />
        <p className="font-inter text-white pt-1.25 pr-4.5 xs:w-125 2xl:w-150">
